function Get-PublicDnsServers
{
    ...
    .EXAMPLE
        ...
        Mullvad       194.242.2.2                  2a07:e340::2                                     https://dns.mullvad.net/dns-query
    ...
    .OUTPUTS
        ...
        DoHUrl, and PrivacyPolicyUrl properties.
    ...
    process
    {
        $servers = @(
            ...
            [PSCustomObject]@{
                ...
                IPv4Secondary    = $null
                IPv6Primary      = '2a07:e340::2'
                IPv6Secondary    = $null
                DoHUrl           = 'https://dns.mullvad.net/dns-query'
                PrivacyPolicyUrl = 'https://mullvad.net/en/help/no-logging-data-policy/'
            }
            [PSCustomObject]@{
                Name             = 'Control D'
